...
function drawMainTempDisplay(parent, data, fahrenheit) {
  ...
  addElement(
    ...
    ['temp'],
    tempString(Weather.temperature(data.current, fahrenheit)),
  );
  addElement(
    'p',
    mainTemperatureContainer,
    [],
    Weather.condition(data.current),
  );
  ...
  addElement(
    ...
    high,
    ['temp'],
    tempString(Weather.highTemp(data, fahrenheit)),
  );
  ...
  addElement(
    ...
    low,
    ['temp'],
    tempString(Weather.lowTemp(data, fahrenheit)),
  );
}
...
function drawMoreInfoDisplay(parent, data, fahrenheit) {
  ...
  addElement(
    ...
    feels,
    ['temp'],
    tempString(Weather.feelsLike(data.current, fahrenheit)),
  );
